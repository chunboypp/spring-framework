 ...
 *	从其父级继承设置的Bean的Bean定义。子bean定义对父bean定义有固定的依赖性。
 *  子bean定义将从父对象继承构造函数参数值，属性值和方法重写，并可以选择添加新值。
 ...
 * 该类允许通过GenericBeanDefinition.setParentName（java.lang.String）方法动态定义父依赖项。
